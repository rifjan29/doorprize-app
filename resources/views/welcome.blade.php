...
<html lang="{{ str_replace('_', '-', app()->getLocale()) }}">
    ...
    <body class="h-fit">
        ...
        <div class="mx-auto">
            ...
            <section class="bg-white dark:bg-gray-900 max-w-4xl border-4 mx-auto mt-48 mb-5 border-gray-800" id="form-dooprize">
                <div class="py-8 px-4 mx-auto max-w-screen-xl lg:py-16 lg:px-12 space-y-6">
                    <h1 class="mb-10 from-indigo-500 via-purple-500 to-pink-500 text-4xl font-extrabold text-center tracking-tight leading-none text-gray-900 md:text-5xl lg:text-6xl dark:text-white underline decoration-wavy decoration-indigo-500">RANDOM DOORPRIZE</h1>
                        ...
                        <form id="dooprizeForm" class="max-w-full mx-auto space-y-6">
                            ...
                            <div>
                                ...
                                <div class="relative">
                                    ...
                                    <input type="text" id="jumlah" name="jumlah" class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-gray-800 focus:border-gray-800 block w-full ps-10 p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-gray-800 dark:focus:border-gray-800" placeholder="Jumlah yang mendapatkan...">
                                </div>
                            </div>
            ...
            <section class="bg-white dark:bg-gray-900 w-1/2 border-4 mx-auto border-gray-800 mt-28 mb-5 hidden" id="list-pemenang">
                <div class="py-8 px-4 mx-auto max-w-screen-xl lg:py-16 lg:px-12 space-y-6">
                    ...
                    success: function(data) {
                        if (data != 'Tidak ada pemenang') {
                            ...
                            $.each(data, function(index, winner) {
                                winnersList.append(`
                                    <tr class="bg-white border-2 border-gray-800 dark:bg-gray-800 dark:border-gray-700">
                                        <th scope="row" class="px-6 py-4 font-medium text-gray-900 whitespace-nowrap dark:text-white border-2 border-gray-800">
                                            ${winner.recipient}
                                        </th>
                                        <td class="px-6 py-4">
                                            ${winner.prize}
